...
- **Model weights** (distributed separately on Hugging Face): governed by the
  [Gemma Terms of Use](https://ai.google.dev/gemma/terms), not MIT. **Built with Gemma.**

This is an independent, unofficial project. It is **not** affiliated with, endorsed by, or sponsored
by Google or Apple. "Gemma" is a trademark of Google LLC; "Core ML" and "Apple Silicon" are
